"""
Django settings for SkeletonES project.
...
# Reading config
config_path = "SkeletonES/config-example.ini"
...
WSGI_APPLICATION = 'SkeletonES.wsgi.application'
